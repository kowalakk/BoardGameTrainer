...
namespace Game.Othello.Tests
{
    public class OthelloTests
    {
        ...
        {
            Assert.Equal(GameResult.InProgress, othello.GameResult(OthelloState.GenerateInitialOthelloState()));
        }
        ...
        void GameResultShouldReturnCorrectWinner()
        {
            ...
            Assert.Equal(GameResult.PlayerTwoWins, othello.GameResult(new OthelloState(white, 0, 0, true)));
            Assert.Equal(GameResult.PlayerOneWins, othello.GameResult(new OthelloState(black, 0, 0, true)));
            Assert.Equal(GameResult.Draw, othello.GameResult(new OthelloState(half, 0, 0, true)));
        }
